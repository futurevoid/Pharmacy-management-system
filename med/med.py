...
class Pharmacy:
    def __init__(self, root):
        ...
        self.root.iconbitmap("/home/_0xlol_/Desktop/z/image/doc.ico")
        ...
        self.heading = Label(self.root, text=self.txt, font=(
            "times new roman", 30, "bold"), bg='black', fg="blue", bd=9, relief=RIDGE)
        ...
        search_button = Button(down_buttonframe, text="Search", font=("arial", 13, "bold"), width=10, fg="green", bg="blue",
        ...
        conn = sqlite3.connect(database=r'D:\Courses_2022_2023\Second_semester\OOP_pythonII\Pharmacy-Management-System-Project-in-Python-Source-Code\Pharmacy_management-system-master\pharmacy.db')
        ...
        # image 1
        self.bg = ImageTk.PhotoImage(file=r"D:\Courses_2022_2023\Second_semester\OOP_pythonII\Pharmacy-Management-System-Project-in-Python-Source-Code\Pharmacy_management-system-master\image\med.jpg")
        lbl_bg = Label(left_smallframe, image=self.bg)
        lbl_bg.place(x=370, y=165, width=200, height=150)
        # image 2
        self.bgg = ImageTk.PhotoImage(file=r"D:\Courses_2022_2023\Second_semester\OOP_pythonII\Pharmacy-Management-System-Project-in-Python-Source-Code\Pharmacy_management-system-master\image\medi.jpg")
        ...
        # image 1
        self.bg1 = ImageTk.PhotoImage(file=r"D:\Courses_2022_2023\Second_semester\OOP_pythonII\Pharmacy-Management-System-Project-in-Python-Source-Code\Pharmacy_management-system-master\image\co.jpg")
        lbl_bg1 = Label(right_frame, image=self.bg1)
        lbl_bg1.place(x=0, y=0, width=240, height=100)
        # image 2
        self.bg2 = ImageTk.PhotoImage(file=r"D:\Courses_2022_2023\Second_semester\OOP_pythonII\Pharmacy-Management-System-Project-in-Python-Source-Code\Pharmacy_management-system-master\image\inject.jpg")
    ...
    def search_data(self):
        ...
        conn=sqlite3.connect(database=r'C:\Users\Lenovo\Desktop\Pharmacy_management-system-master\pharmacy.db')
        new_cursor=conn.cursor()
